...
contract quickProposal {
     ...
     address  quicktoken = payable(0x6c28AeF8977c9B773996d0e8376d2EE379446F2f) ;
     IQUICK quickswap = IQUICK(quicktoken);
    ...
    function updateVote() checkToken  public {
